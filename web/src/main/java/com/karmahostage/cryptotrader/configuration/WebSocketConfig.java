...
public class WebSocketConfig extends AbstractWebSocketMessageBrokerConfigurer {
    ...
    @Value("${com.karmahostage.cryptotrader.messaging.ws.stomp-endpoint}")
    private String stompEndpoint;
    @Value("${com.karmahostage.cryptotrader.messaging.ws.app-endpoint}")
    private String appEndpoint;
    @Value("${com.karmahostage.cryptotrader.messaging.ws.heartbeatMillis}")
    private int heartbeatTime;
    @Value("${com.karmahostage.cryptotrader.messaging.ws.disconnectDelayMillis}")
